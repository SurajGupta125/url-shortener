...
export const sendVerificationEmail = async (email, code) => {
    try {
        ...
        const info = await transporter.sendMail({
            ...
            text: `Your OTP is: ${code}`, // Plain text fallback (Zaroori hai Gmail spam filter se bachne ke liye)
            html: `
        ...
        console.error("EXACT EMAIL ERROR:", error);
        throw error; // Controller tak error pahunchane ke liye
    }
};
